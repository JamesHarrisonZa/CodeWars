...
describe.only('tribonacci', () => {
	...
	describe.skip('given signature [1, 1, 1] and n === 10', () => {
	...
	describe.skip('given signature [0, 0, 1] and n === 10', () => {
	...
	describe.skip('given signature [0, 1, 1] and n === 10', () => {
	...
	describe.skip('given signature [1, 0, 0] and n === 10', () => {
	...
	describe.skip('given signature [0, 0, 0] and n === 10', () => {
	...
	describe.skip('given signature [1, 2, 3] and n === 10', () => {
	...
	describe.skip('given signature [3, 2, 1] and n === 10', () => {
	...
	describe.skip('given signature [1, 1, 1] and n === 1', () => {
	...
	describe.skip('given signature [300, 200, 100] and n === 0', () => {
	...
	describe.skip('given signature [0.5, 0.5, 0.5] and n === 30', () => {
